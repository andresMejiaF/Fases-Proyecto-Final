...
insert into usuario values ("456", "santiago@12", "santiago Mejia", "usuario04",  "direwolf", 123);
insert  into usuario values("777", "michell@123", "carlos", "carlitos13",  "elPibe", 123);
insert into usuario values ("888", "julio39@12", "julio jaramillo", "julito12",  "jaramillo09", 3312);
insert into usuario values ("459", "santiago@12870", "andres santiago Mejia", "usuarioRE4",  "AndresM", 123);
